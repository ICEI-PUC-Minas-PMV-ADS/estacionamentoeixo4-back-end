...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiBody)({ description: 'Veículo criado', type: create_veiculo_dto_1.CreateVeiculoDto }),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, swagger_1.ApiBody)({ description: 'Veículos', type: update_veiculo_dto_1.UpdateVeiculoDto }),
    (0, swagger_1.ApiResponse)({
        status: 200,
